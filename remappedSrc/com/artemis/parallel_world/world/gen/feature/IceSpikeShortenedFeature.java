...
public class IceSpikeShortenedFeature extends Feature<DefaultFeatureConfig> {

    public IceSpikeShortenedFeature(Codec<DefaultFeatureConfig> codec) {
        super(codec);
    }
    ...
    public boolean generate(FeatureContext<DefaultFeatureConfig> context) {
        ...
        for (int o = -k; o <= k; ++o) {
            for (l = -k; l <= k; ++l) {
                ...
                while (blockPos2.getY() > context.getOrigin().getY() -12 && ((blockState2 = structureWorldAccess.getBlockState(blockPos2)).isAir() || IceSpikeFeature.isSoil(blockState2) || blockState2.isOf(Blocks.SNOW_BLOCK) || blockState2.isOf(Blocks.ICE) || blockState2.isOf(Blocks.PACKED_ICE))) {
