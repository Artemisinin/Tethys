...
public class FlyingCatWalkAroundGoal extends Goal {
    ...
    public FlyingCatWalkAroundGoal(PathAwareEntity mob, double speed) {
        this(mob, speed, 120);
    }

    public FlyingCatWalkAroundGoal(PathAwareEntity mob, double speed, int chance) {
        this(mob, speed, chance, true);
    }

    public FlyingCatWalkAroundGoal(PathAwareEntity pathAwareEntity, double d, int i, boolean bl) {
