...
public class TethysItems {
    ...
    public static final Item BASSWOOD_SLAB = new BlockItem(TethysBlocks.BASSWOOD_SLAB, new Item.Settings());
    ...
    public static final Item BLACKCURRANT_SLAB = new BlockItem(TethysBlocks.BLACKCURRANT_SLAB, new Item.Settings());
    ...
    public static final Item CHERRY_SLAB = new BlockItem(TethysBlocks.CHERRY_SLAB, new Item.Settings());
    ...
    public static final Item DOGWOOD_SLAB = new BlockItem(TethysBlocks.DOGWOOD_SLAB, new Item.Settings());
    ...
    public static final Item ELDERBERRY_SLAB = new BlockItem(TethysBlocks.ELDERBERRY_SLAB, new Item.Settings());
    ...
    public static final Item GINKGO_SLAB = new BlockItem(TethysBlocks.GINKGO_SLAB, new Item.Settings());
    ...
    public static final Item SWEETGUM_SLAB = new BlockItem(TethysBlocks.SWEETGUM_SLAB, new Item.Settings());
    ...
    public static void registerItems() {
        ...
        Registry.register(Registries.ITEM, new Identifier("parallel_world", "basswood_slab"), BASSWOOD_SLAB);
        ...
        Registry.register(Registries.ITEM, new Identifier("parallel_world", "blackcurrant_slab"), BLACKCURRANT_SLAB);
        ...
        Registry.register(Registries.ITEM, new Identifier("parallel_world", "cherry_slab"), CHERRY_SLAB);
        ...
        Registry.register(Registries.ITEM, new Identifier("parallel_world", "dogwood_slab"), DOGWOOD_SLAB);
        ...
        Registry.register(Registries.ITEM, new Identifier("parallel_world", "elderberry_slab"), ELDERBERRY_SLAB);
        ...
        Registry.register(Registries.ITEM, new Identifier("parallel_world", "ginkgo_slab"), GINKGO_SLAB);
        ...
        Registry.register(Registries.ITEM, new Identifier("parallel_world", "sweetgum_slab"), SWEETGUM_SLAB);
